...
export function TopicCard({ title, description, icon: Icon, explainer, keywords }: TopicCardProps) {
  ...
  return (
    <button
      ...
      className="w-full text-left p-6 rounded-lg border border-border/60 hover:border-primary/40 bg-card hover:bg-card/80 transition-all group"
    >
      ...
      {/* Expandable Drawer */}
      {isExpanded && (
        <div className="mt-4 pt-4 border-t border-border/30 space-y-3 animate-in fade-in-50 duration-200">
          ...
          <div className="flex gap-2 pt-1">
            <button className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded text-xs font-medium bg-secondary/12 border border-secondary/25 text-secondary/90 hover:bg-secondary/20 transition-colors">
            ...
            <button className="inline-flex items-center gap-1.5 px-2.5 py-1.5 rounded text-xs font-medium bg-primary/12 border border-primary/25 text-primary/90 hover:bg-primary/20 transition-colors">
              <span className="inline-block w-3 h-3">
                <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 12 12">
